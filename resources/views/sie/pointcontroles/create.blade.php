...
@section('title', 'Nouveau point de contrôle')

@section('content')
    <h3 class="mb-4">Nouveau point de contrôle</h3>
    ...
    <div class="card" style="max-width: 700px;">
        <div class="card-body">
            <form method="POST" action="{{ route('sie.pointcontroles.store') }}">
                @csrf
                <div class="row g-3">
                    <div class="col-md-6">
                ...
                <a href="{{ route('sie.pointcontroles.index') }}" class="btn btn-outline-secondary mt-3">Annuler</a>
            </form>
        </div>
    </div>
@endsection
