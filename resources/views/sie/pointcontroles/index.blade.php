    ...
    var table = $('#pointsTable').DataTable({
        ...
        columns: [
            ...
            { data: 'actif', name: 'actif', render: (d) => d ? '<span class="badge bg-success">Actif</span>' : '<span class="badge bg-secondary">Inactif</span>' },
            {
                ...
                render: (d) => `<a href="/sie/pointcontroles/${d.id}" class="btn btn-sm btn-info me-1"><i class="ti ti-eye"></i></a>
                    <a href="/sie/pointcontroles/${d.id}/edit" class="btn btn-sm btn-warning"><i class="ti ti-pencil"></i></a>`
            },
        ],
