...
@section('title', 'Points de contrôle')

@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h3 class="mb-0">Points de contrôle</h3>
        <a href="{{ route('sie.pointcontroles.create') }}" class="btn btn-primary">
...
$(function () {
    var table = $('#pointsTable').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '{{ route('sie.pointcontroles.getPointControles') }}',
            data: function (d) {
        ...
        columns: [
            ...
            { data: 'actif', name: 'actif', render: (d) => d ? '<span class="badge bg-success">Actif</span>' : '<span class="badge bg-secondary">Inactif</span>' },
            {
                ...
                render: (d) => `<a href="/sie/pointcontroles/${d.id}" class="btn btn-sm btn-info me-1"><i class="bi bi-eye"></i></a>
                    <a href="/sie/pointcontroles/${d.id}/edit" class="btn btn-sm btn-warning"><i class="bi bi-pencil"></i></a>`
            },
        ],
