...
@section('content')
    ...
    <div class="card" style="max-width: 700px;">
        <div class="card-body">
            <form method="POST" action="{{ route('superviseur.pointcontroles.update', $pointControle->id) }}">
                @csrf
                @method('PUT')
                <div class="row g-3">
                    <div class="col-md-6">
                ...
                <a href="{{ route('superviseur.pointcontroles.show', $pointControle->id) }}" class="btn btn-outline-secondary mt-3">Annuler</a>
            </form>
        </div>
    </div>
@endsection
