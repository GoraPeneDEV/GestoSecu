...
@section('content')
    <a href="{{ route('superviseur.pointcontroles.index') }}" class="btn btn-sm btn-outline-secondary mb-3">
    ...
    <div class="d-flex justify-content-between align-items-start mb-4">
        ...
        <div>
            <a href="{{ route('superviseur.pointcontroles.edit', $pointControle->id) }}" class="btn btn-warning btn-sm">
                <i class="ti ti-pencil"></i> Modifier
            </a>
            <a href="{{ route('superviseur.pointcontroles.download-qr', $pointControle->id) }}" class="btn btn-outline-secondary btn-sm">
