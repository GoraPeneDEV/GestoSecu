...
class PlanningController extends Controller
{
    public function index()
    {
        ...
        return view('rh.plannings.index', compact('employes', 'sites', 'planningsActifs'));
    }
    ...
    public function create()
    {
        ...
        return view('rh.plannings.create', compact('employes', 'sites', 'horaires'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('rh.plannings.edit', compact('planning', 'sites', 'horaires'));
    }
