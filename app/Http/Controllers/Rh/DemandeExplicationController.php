...
class DemandeExplicationController extends Controller
{
    public function index()
    {
        ...
        return view('rh.demandes-explications.index', compact('stats'));
    }
    ...
    public function create()
    {
        ...
        return view('rh.demandes-explications.create', compact('employes'));
    }
    ...
    public function edit(DemandeExplication $demande)
    {
        ...
        return view('rh.demandes-explications.edit', compact('demande', 'employes'));
    }
    ...
    public function show(DemandeExplication $demande)
    {
        ...
        return view('rh.demandes-explications.show', compact('demande'));
    }
