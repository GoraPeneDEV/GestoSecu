...
class JourFerierController extends Controller
{
    public function index()
    {
        ...
        return view('jours_ferier.index');
    }
    ...
    public function create()
    {
        ...
        return view('jours_ferier.create');
    }
    ...
    {
        return view('jours_ferier.show', compact('jourFerier'));
    }
    ...
    public function trashed()
    {
        ...
        return view('jours_ferier.trashed', compact('joursFerierTrashed'));
    }
