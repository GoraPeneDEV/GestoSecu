...
class DemandeAbsenceAdminController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('absences-admin.index', compact('stats', 'employe'));
    }
    ...
    public function departement()
    {
        ...
        return view('absences-admin.departement', compact(
    ...
    public function create()
    {
        ...
        $routeLibre = false;
        return view('absences-admin.create', compact('employe', 'routeLibre'));
    }
    ...
    public function show(DemandeAbsenceAdmin $demande)
    {
        ...
        return view('absences-admin.show', compact('demande'));
    }
    ...
    public function suiviGlobal()
    {
        ...
        return view('absences-admin.suivi-global', compact('stats', 'departements', 'isRH', 'isDirection'));
    }
    ...
    public function createEnregistrementDirect()
    {
        ...
        return view('absences-admin.enregistrement-direct', compact('employes'));
    }
    ...
    public function demandesEnCours()
    {
        ...
        return view('absences-admin.demandes-en-cours', compact('stats'));
    }
    ...
    public function monSolde()
    {
        ...
        return view('absences-admin.mon-solde', compact('employe', 'demandes', 'stats'));
    }
    ...
    public function edit(DemandeAbsenceAdmin $demande)
    {
        ...
        return view('absences-admin.edit', compact('demande'));
    }
